...
survivalistInventory:
    ...
    definitions:
        ...
        backpack_9: <item[Backpack_9].with[nbt=item/Backpack_9;display_name=<&a>Backpack;lore=<&e>Slots:<&sp><&a>9|<&a>Buy<&sp>Price:<&sp><&e><script[survivalistData].data_key[Items.Backpack_9.Prices].before[/]>|<&c>Sell<&sp>Price:<&sp><script[survivalistData].data_key[Items.Backpack_9.Prices].after[/]>]>
        backpack_18: <item[Backpack_18].with[nbt=item/Backpack_18;display_name=<&a>Backpack;lore=<&e>Slots:<&sp><&a>18|<&a>Buy<&sp>Price:<&sp><&e><script[survivalistData].data_key[Items.Backpack_18.Prices].before[/]>|<&c>Sell<&sp>Price:<&sp><script[survivalistData].data_key[Items.Backpack_18.Prices].after[/]>]>
        backpack_27: <item[Backpack_27].with[nbt=item/Backpack_27;display_name=<&a>Backpack;lore=<&e>Slots:<&sp><&a>27|<&a>Buy<&sp>Price:<&sp><&e><script[survivalistData].data_key[Items.Backpack_27.Prices].before[/]>|<&c>Sell<&sp>Price:<&sp><script[survivalistData].data_key[Items.Backpack_27.Prices].after[/]>]>
        backpack_36: <item[Backpack_36].with[nbt=item/Backpack_36;display_name=<&a>Backpack;lore=<&e>Slots:<&sp><&a>36|<&a>Buy<&sp>Price:<&sp><&e><script[survivalistData].data_key[Items.Backpack_36.Prices].before[/]>|<&c>Sell<&sp>Price:<&sp><script[survivalistData].data_key[Items.Backpack_36.Prices].after[/]>]>
        backpack_45: <item[Backpack_45].with[nbt=item/Backpack_45;display_name=<&a>Backpack;lore=<&e>Slots:<&sp><&a>45|<&a>Buy<&sp>Price:<&sp><&e><script[survivalistData].data_key[Items.Backpack_45.Prices].before[/]>|<&c>Sell<&sp>Price:<&sp><script[survivalistData].data_key[Items.Backpack_45.Prices].after[/]>]>
        backpack_54: <item[Backpack_54].with[nbt=item/Backpack_54;display_name=<&a>Backpack;lore=<&e>Slots:<&sp><&a>54|<&a>Buy<&sp>Price:<&sp><&e><script[survivalistData].data_key[Items.Backpack_54.Prices].before[/]>|<&c>Sell<&sp>Price:<&sp><script[survivalistData].data_key[Items.Backpack_54.Prices].after[/]>]>
        grappling_hook: <item[tripwire_hook].with[nbt=item/Grappling_Hook;display_name=<&a>Grappling<&sp>Hook;lore=<&a>Buy<&sp>Price:<&sp><&e><script[survivalistData].data_key[Items.Grappling_Hook.Prices].before[/]>|<&c>Sell<&sp>Price:<&sp><script[survivalistData].data_key[Items.Grappling_Hook.Prices].after[/]>]>
